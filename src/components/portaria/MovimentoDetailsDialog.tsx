            ...
            {hasFotos && (
              <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {m.foto_placa_url && (
                    <div>
                      <ClickablePhoto url={m.foto_placa_url} alt="Placa" label="Foto da Placa" />
                      {m.texto_placa_lido && (
                  ...
                  {m.foto_documento_url && (
                    <ClickablePhoto url={m.foto_documento_url} alt="Documento" label="Documento" />
                  )}
                  {m.foto_painel_url && (
                    <ClickablePhoto url={m.foto_painel_url} alt="Painel" label="Painel (KM)" />
                  )}
                  {m.foto_nota_url && (
                    <ClickablePhoto url={m.foto_nota_url} alt="Nota Fiscal" label="Nota Fiscal" />
                  )}
                </div>
              </div>
            )}
